      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-blue-100 max-w-3xl mx-auto">
            Contact us today for a free consultation and quote. Our expert team is ready to 
            help you find the perfect elevator solution for your needs.
          </p>
        </div>
        ...
        <div className="text-center">
          ...
          <p className="text-blue-200 mt-6 text-sm">
            ✓ Free consultation ✓ Same-day response ✓ Expert guidance ✓ Competitive pricing
          </p>
        </div>
      </div>
    </section>
