      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {products.map((product, index) => (
            ...
            >
              <Card 
                className="group cursor-pointer border border-gray-200 shadow-xl hover:shadow-2xl transition-all duration-500 hover:-translate-y-3 bg-white rounded-2xl overflow-hidden h-full"
              >
                <CardContent className="p-0 h-full flex flex-col">
                  ...
                  <div className="p-8 flex-1 flex flex-col">
                    ...
                    <div className="space-y-3 mb-8">
                      {product.features.map((feature, idx) => (
                        <div key={idx} className="flex items-center text-gray-700">
                          ...
                          <span className="font-medium font-inter">{feature}</span>
                        </div>
                      ))}
                    </div>
                    ...
                    {/* Learn More Button */}
                    <Button 
                      className="w-full bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white py-3 font-semibold rounded-xl transition-all duration-300 shadow-lg hover:shadow-xl font-poppins"
                    >
                      Learn More
        ...
        >
          <div className="bg-white rounded-2xl p-8 shadow-xl border border-gray-200 max-w-2xl mx-auto">
            ...
            <p className="text-gray-600 mb-6 leading-relaxed font-inter">
              Discover our complete range of elevator solutions tailored to your needs.
            </p>
            <Link to="/innovation">
            <Button 
              size="lg"
