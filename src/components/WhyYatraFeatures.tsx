  ...
  const features = [
    {
      ...
      description: "Advanced IoT integration for predictive maintenance and real-time monitoring",
      metric: "99.9%",
      metricLabel: "Uptime",
    ...
    },
    {
      ...
      description: "Multi-layered safety systems with emergency protocols and backup power",
      metric: "30,000+",
    ...
    },
    {
      ...
      description: "Comprehensive maintenance and 24/7 support for the entire product lifecycle",
      metric: "5,000+",
    ...
    },
    {
      ...
      description: "Proven track record with ICONIC Group's engineering excellence and innovation",
      metric: "15+",
          ...
          {features.map((feature, index) => (
            ...
            >
              ...
              <div className="relative p-8 bg-white/80 backdrop-blur-sm border border-white/20 rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-300">
                ...
                {/* Icon */}
                <div className={`relative mb-6 w-16 h-16 bg-gradient-to-br ${feature.color} rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300`}>
                ...
                <div className="relative">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="relative">
                      ...
                      <div className={`absolute inset-0 w-3 h-3 bg-gradient-to-r ${feature.color} rounded-full animate-ping opacity-20`} />
                    </div>
                  </div>
                </div>

                {/* Hover Border Effect */}
                <div className={`absolute inset-0 border-2 border-transparent bg-gradient-to-br ${feature.color} rounded-2xl opacity-0 group-hover:opacity-20 transition-opacity duration-300 -z-10`} 
                     style={{ padding: '2px' }}>
        ...
        >
          ...
          <div className="relative grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            <div>
              ...
              <div className="text-sm text-blue-200 font-inter">System Uptime</div>
            </div>
            <div>
              <div className="text-3xl md:text-4xl font-bold mb-2 font-poppins">
                {shouldReduceMotion ? '30,000' : Math.floor(counters.trips).toLocaleString()}+
              </div>
              <div className="text-sm text-blue-200 font-inter">Daily Trips</div>
            </div>
            <div>
              <div className="text-3xl md:text-4xl font-bold mb-2 font-poppins">
                {shouldReduceMotion ? '5,000' : Math.floor(counters.customers).toLocaleString()}+
              </div>
              <div className="text-sm text-blue-200 font-inter">Satisfied Customers</div>
            </div>
            <div>
              <div className="text-3xl md:text-4xl font-bold mb-2 font-poppins">
                {shouldReduceMotion ? '15' : Math.floor(counters.years)}+
              </div>
              <div className="text-sm text-blue-200 font-inter">Years of Excellence</div>
            </div>
          </div>
        </motion.div>
      </div>
