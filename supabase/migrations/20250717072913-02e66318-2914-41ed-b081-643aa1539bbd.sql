-- Add leads data with all correct constraint values
INSERT INTO public.leads (
  ...
  ('Amit Kumar', 'amit@hospitalchain.com', '+91-98765-22222', 'MedCare Hospital Chain',
   'Need hospital-grade elevators with emergency features', 'contacted', 'referral', 'partner',
   3500000, '2024-07-24'),
   
  ('Sneha Patel', 'sneha@retailmall.com', '+91-98765-33333', 'Retail Mall Developers',
   'Require freight and passenger elevators for shopping mall', 'quoted', 'showroom', 'walk_in',
   4200000, '2024-07-26'),
   
  ('Rahul Gupta', 'rahul@constructionco.com', '+91-98765-44445', 'Metro Construction Co',
   'Looking for multiple elevators for our upcoming projects', 'contacted', 'bulk', 'trade_show',
   7500000, '2024-07-28'),
  ...
  ('Manoj Agrawal', 'manoj@corporatetower.com', '+91-98765-77778', 'Corporate Tower Ltd',
   'Express elevators needed for high-rise office building', 'quoted', 'showroom', 'appointment',
   4800000, '2024-08-02'),
   
  ('Sunita Reddy', 'sunita@greenspaces.com', '+91-98765-88889', 'Green Spaces Development',
   'Sustainable elevator solutions for eco-friendly buildings', 'lost', 'website', 'advertisement',
   3200000, '2024-07-20');

-- Add contact inquiries with correct status values
INSERT INTO public.contacts (
  ...
  ('Kavya Reddy', 'kavya@officecomplex.com', '+91-98765-55555', 'Corporate Office Complex',
   'Need quotation for high-speed elevators for 25-floor office building', 'in_progress'),
  ...
  ('Arjun Nair', 'arjun@shoppingmalls.com', '+91-98765-88888', 'Premium Shopping Malls',
   'Planning elevator installation for 3 new malls opening next year', 'in_progress'),
   
  ('Deepika Patel', 'deepika@apartmentchain.com', '+91-98765-99999', 'Apartment Chain Ltd',
   'Bulk order inquiry for 15 residential complexes', 'resolved'),
  ...
  ('Anita Mehta', 'anita@luxuryhotels.com', '+91-98765-12121', 'Luxury Hotels International',
   'Custom elevator design for premium hotel chain', 'in_progress'),
  ...
  ('Pooja Sharma', 'pooja@greentowers.com', '+91-98765-14141', 'Green Towers Development',
   'Eco-friendly elevator solutions for sustainable buildings', 'resolved');